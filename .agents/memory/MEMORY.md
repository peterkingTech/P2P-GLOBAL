...
- [P2P Bible System](p2p-bible-system.md) — Secret is API_Bible (not API_BIBLE_KEY); 8 languages registered with confirmed catalog IDs; German LUT ID was wrong placeholder, now fixed.
