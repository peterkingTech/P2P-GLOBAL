...
// split (My Discipleship Phase 2) moved it here unchanged and put a slim
// two-card Journey/Journal chooser at index.tsx instead. Content is almost
// entirely a consolidation of infrastructure that already works elsewhere:
// My Peer Guide / My Disciples (moved from connect/index.tsx, which no
// longer shows them — see that file's own comment), Kingdom Impact (moved
// wholesale from progress.tsx, same RPCs, same numbers — My Progress no
// longer shows it), and link-outs to Requests/Confirmations/Completion
// Letters/Forest/Fruit/Kingdom School/Sessions, which stay as their own
// screens per the product decision to consolidate the dashboard, not
// re-implement every detail screen inside it.
...
export default function MyDiscipleshipJourneyScreen() {
  ...
  return (
    <View style={[s.container, { paddingTop: insets.top }]}>
      ...
      <View style={s.header}>
        ...
        <Text style={s.headerTitle}>My Discipleship Journey</Text>
      </View>
