...
export default function ScriptureDevotionalScreen() {
  ...
  if (!scripture) return <><Stack.Screen options={{ headerShown: false }} /><View style={[styles.screen, styles.centerFill]}><Text style={styles.emptyText}>This Scripture isn't available right now.</Text></View></>;
