...
export default function NotificationsScreen() {
  ...
  const { getMyNotifications, markNotificationRead } = useData();
  ...
  async function handlePress(n: AppNotification) {
    ...
    // since ended rather than navigating into a broken/stale screen.
    if (n.notificationType === "study_leader_transfer" && n.data?.callId) {
